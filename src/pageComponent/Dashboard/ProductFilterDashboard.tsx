...
const FilterDashboard = () => {
    ...
    return (
        <div className="relative">
            ...
            <div
                className={`lg:w-full bg-white p-6 shadow-md lg:flex fixed inset-0 z-20 transition-transform ${isDrawerOpen ? 'transform-none' : 'transform -translate-x-full'
            ...
            >
                ...
                <h2 className="text-2xl font-semibold mb-6 text-gray-800"><span className="text-sm cursor-pointer underline" onClick={resetFilters}> Clear Filters X</span></h2>
                        ...
                        {[...Array(5)].map((_, index) => {
                            ...
                            return (
                                <button
                                    key={ratingValue}
                                    type="button"
                                    className={`p-1 ${ratingValue <= Number(minRating) ? 'text-yellow-500' : 'text-gray-400'}`}
                                    onClick={() => {
                                        setSearchParams((prev) => {
                                            const newParams = new URLSearchParams(prev);
                                            newParams.set('minRating', ratingValue.toString()); // Ensure minRating is a string
                                            return newParams;
                                        });
                                    }}
                                >
